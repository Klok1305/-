...
Из любого тензора можно получить симметрический или кососимметрический, усредняя по всем перестановкам. Эти операции — проекторы.
...
с операцией $\wedge$. Это **градуированно-коммутативная ассоциативная алгебра**: $\alpha \wedge \beta = (-1)^{\lvert\alpha\rvert\lvert\beta\rvert} \beta \wedge \alpha$, где $\lvert\alpha\rvert, \lvert\beta\rvert$ — степени (= $p$ и $q$).
